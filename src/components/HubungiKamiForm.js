...
class HubungiKamiForm extends Component {
  ...
  render() {
    ...
    if (this.state.hasEmailError) {
      emailErrorText = (<p className="hubungikamiform-message-error">Masukkan alamat email Anda</p>);
    }
    
    let pesanErrorText = "";
    if (this.state.hasPesanError) {
      pesanErrorText = (<p className="hubungikamiform-message-error">Masukkan pesan Anda</p>);
    }

    let hubungiKamiForm = "";
    if (this.state.isSubmitted) {
      hubungiKamiForm = (<div className="hubungiKamiForm-submit-message">Pesan Terkirim</div>);
    } else {
      hubungiKamiForm = (
